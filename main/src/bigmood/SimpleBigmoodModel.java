 ...
 */
public class SimpleBigmoodModel extends BigmoodModel {
     ...
     */
    @Override
    public double calcBigmoodDemPercent(District district, double nationalShift) {
     ...
     */
    @Override
    public double calcBigmoodStDv(District district, double nationalShift) {
